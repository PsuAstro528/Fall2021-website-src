...
If the University is closed on the due date of an assignment (due to bad weather or any other reason), then the assignment will be due by 11am before the next class session (that is not canceled).
...
All students should submit an average of at least one question per week about the week's readings via [TopHat](https://app.tophat.com/e/708625) by 11am Eastern Time on the day of discussion-based classes (typically Mondays; as opposed to Thursdays which will typically be lab-based classes).  There is a link to the course TopHat site inside the Canvas webpage.  Submitting well before class starts is important, so the instructor will have time to read the questions and organize the day’s discussion based on actual student questions.  You're also encouraged to take a look at questions submitted by other students and give a "thumbs up" to indicate those questions that you'd also like to be addressed in class.  In the event of technically difficulties, you can email your question to the instructor with "Astro 528 Reading Question" in the subject line.  
